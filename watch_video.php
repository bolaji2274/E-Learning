...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'Yọ kuro ninu awọn fẹran!';
      }else{
         ...
         $message[] = 'Ti a fi si awọn feran!';
      }

   }else{
      $message[] = 'Jọwọ wọle ni akọkọ!';
   }
   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            ...
            $message[] = 'Ọ̀rọ̀ tuntun fi kún un!';
         }

      }else{
         $message[] = 'Nkan kan kò tọ̀nà!';
      }
...
if(isset($_POST['update_now'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Ọrọìwòye ti a ṣatunkọ ni ifijišẹ!';
   }
...
<section class="edit-comment">
   <h1 class="heading">ṣatunkọ asọye</h1>
   <form action="" method="post">
      <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="jowo te re oroiwoye" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
         <a href="watch_video.php?get_id=<?= $get_id; ?>" class="inline-option-btn">fagilee edit</a>
         <input type="submit" value="Mú bágbà mu báyìí" name="update_now" class="inline-btn">
      </div>
   </form>
</section>
<?php
   }else{
      $message[] = 'Wọn kò rí ọ̀rọ̀!';
   }
}
?>
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <div class="info">
         ...
         <p><i class="fas fa-heart"></i><span><?= $total_likes; ?> feran</span></p>
      </div>
      <div class="tutor">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">wo akojo orin</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>feran</span></button>
         <?php
         }else{
         ?>
         <button type="submit" name="like_content"><i class="far fa-heart"></i><span>feran</span></button>
         <?php
            }
         ?>
      </form>
   ...
   <?php
         ...
         echo '<p class="empty">Ko si awọn fidio ti a fi kun sibẹsibẹ!</p>';
      }
   ?>
...
<section class="comments">
   ...
   <h1 class="heading">Fi ọrọìwòye</h1>

   <form action="" method="post" class="add-comment">
      <input type="hidden" name="content_id" value="<?= $get_id; ?>">
      <textarea name="comment_box" required placeholder="Kọ asọye rẹ ..." maxlength="1000" cols="30" rows="10"></textarea>
      <input type="submit" value="add comment" name="add_comment" class="inline-btn">
   </form>

   <h1 class="heading">Awon akiyesi olumulo</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Ṣe àtúnṣe akiyesi</button>
