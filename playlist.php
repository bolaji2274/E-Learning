   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>ti fipamọ</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>fi àtòjọ orin pamọ́</span></button>
            <?php
               }
            ?>
         </form>
         <div class="thumb">
            <span><?= $total_videos; ?> awọn fidio</span>
      ...
      <?php
            ...
            echo '<p class="empty">A kò rí àtòjọ orin yìí!</p>';
         }  
      ?>
