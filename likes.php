...
<section class="liked-videos">
   ...
   <h1 class="heading">fidio ti o fẹran</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">wo fidio</a>
         <input type="submit" value="pa rẹ́" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">A kò rí àkóónú!</p>';         
         }
      }
   }else{
      echo '<p class="empty">Kò sí ohun tí a fi kún àwọn tí ó fẹ́ràn síbẹ̀!</p>';
   }
   ?>
