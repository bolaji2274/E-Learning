   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="col">
            ...
            <input type="email" name="email" placeholder="tẹ imeeli rẹ sii" maxlength="20" required class="box">
         </div>
         <div class="col">
      ...
      <p class="link">Ti ní àkáùntì tẹ́lẹ̀? <a href="login.php">wọle bayi</a></p>
